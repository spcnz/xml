...
public class ObavestenjeZalba {
    ...
    protected TObZalbaDokument obZalbaDokument;
    @XmlAnyAttribute
     ...
     * @return
     *     possible object is
     *     {@link TObZalbaDokument }
     *     
     */
    public TObZalbaDokument getObZalbaDokument() {
     ...
     *     
     */
    public void setObZalbaDokument(TObZalbaDokument value) {
