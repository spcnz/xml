...
/**
 * <p>Java class for DecisionAppealList complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DecisionAppealList"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DecisionAppealList", propOrder = {
    "any"
})
public class DecisionAppealList {

    @XmlAnyElement
    protected List<ZalbaRoot> any;
     ...
     * 
     */
    public List<ZalbaRoot> getAny() {
        if (any == null) {
            any = new ArrayList<ZalbaRoot>();
        }
        return this.any;
    }
